...
export const AboutView: React.FC = () => (
    <div className="max-w-4xl mx-auto animate-fade-in">
        <div className="bg-white rounded-lg shadow-lg border-t-4 border-teal-400 p-8 prose prose-teal max-w-none">
            ...
            <h2>Why Babble Vibe?</h2>
            <p>While traditional apps teach you words, Babble Vibe teaches you how to <em>use</em> them. Powered by Google's state-of-the-art Gemini models, we offer a suite of unique, monetizable features that you won't find anywhere else:</p>
            <ul>
            ...
            <p>At the heart of Babble Vibe is the Gemini API, enabling us to create hyper-realistic learning environments. From the <strong>Live API (Gemini 2.5 Native Audio)</strong> for our Accent Training to the advanced reasoning of <strong>Gemini 2.5 Pro</strong> for our Grammar Clinics, we leverage cutting-edge AI to deliver a learning experience that is both effective and fun.</p>
            <p>Join our community and start your journey to fluency today. With Babble Vibe, you're not just learning a language; you're starting a new conversation with the world.</p>
        </div>
    </div>
);
